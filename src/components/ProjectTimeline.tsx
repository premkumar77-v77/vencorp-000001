...
const projects: Project[] = [
  {
    id: 6,
    title: "Stello",
    description: "Complete business operations suite with automated workflows and smart analytics for modern startups.",
    status: "launched",
    date: "2024-11-01",
    timeline: "Q4 2024",
    team: 18,
    progress: 100,
    tags: ["Operations", "Analytics", "Workflow", "SaaS"],
    metrics: {
      users: "5K+",
      revenue: "$1.2M",
      growth: "+220%"
  ...
  },
  {
    id: 7,
    title: "Pragati",
    description: "AI-powered idea validation platform with real-time market analysis and predictive modeling for entrepreneurs.",
    status: "testing",
    date: "2024-12-15",
    timeline: "Q1 2025",
    team: 10,
    progress: 90,
    tags: ["AI", "Validation", "Market Analysis", "Startup Tools"]
  },
  {
    id: 8,
    title: "Unavar",
    description: "Advanced supply chain optimization platform using AI to reduce costs and improve delivery efficiency.",
    status: "development",
    date: "2025-02-01",
    timeline: "Q2 2025",
    team: 14,
  ...
  },
  {
    id: 9,
    title: "Tnapex",
    description: "Next-generation collaboration platform for remote teams with integrated project management and communication tools.",
    status: "planning",
    date: "2025-03-20",
    timeline: "Q3 2025",
    team: 12,
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex justify-center mb-8">
          <div className="bg-gray-900 border border-gray-700 rounded-2xl p-6 max-w-md w-full">
            <h3 className="text-lg font-semibold text-center mb-4 text-gray-300">Proud Partners</h3>
            <div className="flex justify-center items-center space-x-4">
              <div className="text-2xl font-bold text-white">SVCE</div>
            </div>
          </div>
        </div>
